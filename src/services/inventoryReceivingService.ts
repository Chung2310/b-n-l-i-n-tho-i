...
export type GoodsReceiptItem = { productId: string; variantId: string; barcode?: string; sku?: string; productName?: string; quantity: number; unitCost: number; lineTotal?: number; note?: string; trackingMode?: "none" | "quantity" | "lot" | "serial"; serialNumbers?: string[] };

...
const DEFAULT_STANDARD_FIELDS: Record<ModuleKey, StandardFieldConfig[]> = {
  students: [
    ...
    { key: "email", label: "Email học viên", placeholder: "Nhập địa chỉ email...", type: "email", isRequired: true, isVisible: true, isArchived: false },
  ...
  courses: [
    ...
    { key: "duration", label: "Số buổi học", placeholder: "Ví dụ: 12", type: "number", isRequired: true, isVisible: true, isArchived: false },
  ...
  batches: [
    ...
    { key: "endDate", label: "Ngày bế giảng dự kiến", type: "dateTime", isRequired: true, isVisible: true, isArchived: false },

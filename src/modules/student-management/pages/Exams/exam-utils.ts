...
export function getDrivingExamBucket(rank?: string | null): 'motorbike' | 'car' | null {
...
export function getExamSegmentLabel(businessType: BusinessType, rank?: string | null) {

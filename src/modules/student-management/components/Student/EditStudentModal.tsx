...
import { cn, toInputDate, toDisplayDate, formatVND, compressImage } from '../../lib/utils';
    ...
    if (student) {
      setTimeout(() => {
        ...
        setFormData({
          ...
          idCardFrontFile: student.idCardFrontFile || undefined,
          idCardBackFile: student.idCardBackFile || undefined,
          portraitFile: student.portraitFile || undefined,
        });
      }, 0);
    }
  }, [student, courses]);
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          >
            ...
            <form className="p-6 overflow-y-auto space-y-4" onSubmit={handleSubmit}>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm appearance-none focus:outline-none focus:ring-4 focus:ring-cyan-600/5 focus:border-cyan-600 transition-all cursor-pointer border-slate-200"
                    >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 pt-4 border-t border-slate-100">

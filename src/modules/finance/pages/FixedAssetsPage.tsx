...
import { AlertCircle, Boxes, CheckCircle2, Clock, Edit3, Eye, MoveRight, Plus, Search, Trash2, X } from "lucide-react";
    ...
    <section className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-xs">
          <span className="text-xs font-bold uppercase tracking-wider text-slate-500">Tổng tài sản</span>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-xs">
          <span className="text-xs font-bold uppercase tracking-wider text-cyan-700">Tổng nguyên giá</span>
          <p className="mt-2 text-xl font-black text-cyan-700">{vnd(kpis.totalOriginal)}</p>
          <p className="mt-2 text-xs text-slate-500">Giá trị đầu tư ban đầu</p>
        </div>

        <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-xs">
          <span className="text-xs font-bold uppercase tracking-wider text-slate-700">Giá trị còn lại</span>
          <p className="mt-2 text-xl font-black text-slate-900">{vnd(kpis.totalNet)}</p>
          <p className="mt-2 text-xs text-slate-500">Chưa trích khấu hao</p>
        </div>

        <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-xs">
          <span className="text-xs font-bold uppercase tracking-wider text-rose-600">Đã thanh lý</span>
          <p className="mt-2 text-2xl font-black text-rose-600">{kpis.disposed}</p>
          <p className="mt-2 text-xs text-slate-500">Đã hết vòng đời sử dụng</p>
        </div>
      </div>

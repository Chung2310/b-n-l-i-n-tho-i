...
const REASON_MESSAGES: Record<string, string> = {
  not_registered:
    "Học viên chưa đăng ký khuôn mặt. Vui lòng liên hệ giáo viên/admin để đăng ký trước.",
  invalid_image: "Ảnh không hợp lệ. Vui lòng chụp lại ảnh rõ mặt.",
  no_face:
    "Không phát hiện khuôn mặt trong ảnh. Vui lòng chụp lại, đảm bảo đủ ánh sáng.",
  multiple_faces:
    "Ảnh có nhiều hơn một khuôn mặt. Vui lòng chụp lại chỉ một mình bạn.",
  model_unavailable:
    "Hệ thống nhận diện khuôn mặt tạm thời gián đoạn. Vui lòng thử lại sau ít phút.",
  spoof_detected:
    "Không xác nhận được khuôn mặt thật. Vui lòng chụp ảnh trực tiếp, không dùng ảnh/video khác.",
  face_mismatch: "Khuôn mặt không khớp với hồ sơ đã đăng ký.",
  outside_radius: "Bạn đang ở ngoài khu vực điểm danh cho phép.",
  missing_image:
    "Vui lòng chụp ảnh khuôn mặt và cấp quyền định vị để điểm danh.",
    ...
    const fetchSessionInfo = async () => {
      try {
        ...
        const res = await fetch(
          `/api/v1/qr-attendance/session-info?token=${token}`,
        );
            ...
            <div className="text-center space-y-6 animate-fade-in">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-500 text-sm font-medium mt-3">
                  Bạn đã điểm danh thành công vào buổi học ngày{" "}
            ...
            <div className="text-center space-y-2">
              ...
              <div className="p-4 bg-slate-50 border border-slate-100 rounded-2xl text-left space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-extrabold text-cyan-600 bg-cyan-50 px-2 py-0.5 rounded-md">
                    {sessionInfo?.batchCode}
                  </span>
                </div>
          ...
          <div className="space-y-5">
            <div className="text-center space-y-1">
              ...
              <p className="text-xs text-slate-500 font-medium">
                Nhìn thẳng vào camera, đủ ánh sáng, chỉ một mình bạn trong khung
                hình.
              </p>
            </div>

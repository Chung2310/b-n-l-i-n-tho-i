...
import { AddStudentModal as AddWorkerModal } from "../student-management/components/Student/AddStudentModal";
import { StudentDetailModal as WorkerDetailModal } from "../student-management/components/Student/StudentDetailModal";
import { setEntityPreset } from "../student-management/hooks/entityPresetStore";
import { useAdminCenters } from "../student-management/hooks/useAdminCenters";
import { useStudents as useWorkers } from "../student-management/hooks/useStudents";
import type { Student as WorkerRecord } from "../student-management/types";
import { setBusinessApiScope } from "../student-management/lib/api";
...
const DashboardPage = lazy(() => import("../student-management/pages/Dashboard/DashboardPage").then((module) => ({ default: module.DashboardPage })));
const WorkersPage = lazy(() => import("../student-management/pages/Students/StudentsPage").then((module) => ({ default: module.StudentsPage })));
const ProjectsPage = lazy(() => import("../student-management/pages/Batches/BatchesPage").then((module) => ({ default: module.BatchesPage })));
const NotificationsPage = lazy(() => import("../student-management/pages/Notifications/NotificationsPage").then((module) => ({ default: module.NotificationsPage })));

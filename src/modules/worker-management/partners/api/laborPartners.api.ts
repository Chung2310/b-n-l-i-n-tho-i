...
export const laborPartnersApi = {
  ...
  async listReferralsForWorker(scope: WorkerScope, workerId: string) { return (await workerApiFetch<{ success: true; data: WorkerReferral[] }>(`${base}/workers/${workerId}/referral`, { params: scopeParams(scope) })).data; },

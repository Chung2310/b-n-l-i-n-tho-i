          ...
          <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
            <div>
              <h3 className="text-lg font-black text-slate-800">
                Kết quả kiểm tra dữ liệu Excel
              </h3>
              <p className="text-xs text-slate-400 font-bold mt-0.5">
                Vui lòng kiểm tra lại danh sách trước khi đưa lên hệ thống
              </p>
            </div>
            <button
              onClick={onClose}
                  ...
                  <table className="w-full text-left border-collapse text-xs">
                    <thead>
                      <tr className="bg-slate-50 border-b border-slate-100">
                        ...
                        <th className="px-4 py-3 font-bold text-slate-400 uppercase tracking-wider text-center">
                          Kết quả
                        </th>
                      </tr>
                    </thead>
                          ...
                          <td className="px-4 py-3 text-center">
                            <span
                              className={cn(
                                ...
                                s.overallResult === "Trượt" &&
                                  "bg-rose-50 text-rose-700 border border-rose-100",
                                s.overallResult === "Chưa có" &&
                ...
                <table className="w-full text-left border-collapse text-xs">
                  ...
                  <tbody className="divide-y divide-slate-50">
                    {invalidList.map((s, idx) => (
                      <tr
                        key={idx}
                        className="hover:bg-slate-50/50 bg-rose-50/10"
                      >

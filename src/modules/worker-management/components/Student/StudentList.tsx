            ...
            >
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 pb-4 border-b border-slate-50">
                  <div>
                    <p className="text-[10px] uppercase font-bold text-slate-300 tracking-wider mb-0.5">
                      Hạng bằng
                    </p>
                ...
                <div className="pt-4 flex items-center justify-between">
                  ...
                  <div className="bg-brand-primary/5 px-2 py-1 rounded-lg">
                    <p className="text-[10px] font-bold text-brand-primary font-mono">
                      {formatVND(student.fee)} VND
                    </p>
                  </div>
                </div>
              </div>

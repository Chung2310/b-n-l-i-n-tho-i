...
export function LuxuryButton({
  ...
  const variants = {
    primary:
      "bg-stone-900 text-stone-50 hover:bg-stone-800 shadow-xl shadow-stone-200/50",
    secondary:
      "bg-emerald-800 text-emerald-50 hover:bg-emerald-700 shadow-xl shadow-emerald-200/50",
    outline:

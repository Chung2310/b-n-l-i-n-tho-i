...
export interface RetailOrderInput { collaboratorId?: string; items: RetailOrderItemInput[]; customerId?: string; billingProfileId?: string; orderDiscount: RetailDiscountInput; taxRate: number; shippingFee: number; dueDate?: string }

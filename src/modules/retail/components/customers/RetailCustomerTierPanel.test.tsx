...
vi.mock("../../api/retailCustomers.api", () => ({ retailCustomersApi: { tierHistory: vi.fn().mockResolvedValue([{ _id: "h1", toTierName: "VIP", source: "automatic", changedAt: "2026-08-12" }]), overrideTier: vi.fn().mockResolvedValue({}) } }));
afterEach(cleanup);
it("shows tier timeline and lets managers create a dated override", async () => {
  ...
  await userEvent.selectOptions(screen.getByLabelText("Hạng áp dụng"), "vip");

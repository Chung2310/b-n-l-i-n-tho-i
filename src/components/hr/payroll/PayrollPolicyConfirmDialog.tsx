...
export function PayrollPolicyConfirmDialog({ title, description, impact, confirmLabel, secondaryLabel, tone, pending, error, onCancel, onConfirm, onSecondary }: Props) {

...
export function PayrollPolicyFormModal({ mode, initialDefinition, saving, onCancel, onSave }: Props) {
  ...
  const close = () => { if (dirty) setConfirmDiscard(true); else onCancel(); };

                        ...
                        <div className="flex border-b border-slate-100">
                           <button
                             ...
                             className={`flex-1 pb-2 text-xs font-bold border-b-2 text-center transition-all ${
                                voiceActiveTab === 'my-voices' ? 'border-cyan-500 text-cyan-600' : 'border-transparent text-slate-400'
                             }`}
                           >
                                    ...
                                    return (
                                       <div 
                                         ...
                                         className={`flex items-center justify-between p-3 rounded-xl border transition-all cursor-pointer ${
                                            isSelected ? 'bg-cyan-50/50 border-cyan-300' : 'hover:bg-slate-50 border-slate-100'
                                         }`}
                                       >
                                          <div className="flex items-center gap-3">
                                             <button 
                     ...
                     <div className="space-y-5">
                        ...
                        <div className="flex flex-col gap-1.5">
                           ...
                           <div 
                             ...
                             className="w-full flex items-center justify-between border border-slate-200 rounded-xl p-3.5 bg-slate-50/50 cursor-pointer hover:bg-slate-50 transition-all"
                           >
                              <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between px-16 py-6 border-b bg-slate-50/40 shrink-0">
                     ...
                     <div className="flex flex-col items-center gap-1.5 flex-1">
                        ...
                        <span className={`text-[11px] font-bold transition-all duration-300 ${
                           createStep === 'upload' ? 'text-[#0891b2]' : 'text-slate-400'
                        }`}>
                           Tải lên Audio
                        </span>
                     </div>
                     ...
                     <div className="flex flex-col items-center gap-1.5 flex-1">
                        ...
                        <span className={`text-[11px] font-bold transition-all duration-300 ${
                           createStep === 'info' ? 'text-[#0891b2]' : 'text-slate-400'
                        }`}>
                           Thông tin giọng nói
                        </span>
                     </div>
                     ...
                     <div className="flex flex-col items-center gap-1.5 flex-1">
                        ...
                        <span className={`text-[11px] font-bold transition-all duration-300 ${
                           createStep === 'finish' ? 'text-[#0891b2]' : 'text-slate-400'
                        }`}>
                           Hoàn tất
                        </span>
                     </div>
                     ...
                     <div className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        ...
                        <div className="border-2 border-dashed border-slate-200 hover:border-[#22d3ee]/80 hover:bg-[#e0f7fc]/5 rounded-2xl p-7 flex flex-col items-center justify-center text-center relative transition-all duration-300">
                           ...
                           <button
                             ...
                             className={`px-4 py-2 rounded-xl text-xs font-bold flex items-center gap-1.5 shadow-xs transition-all duration-300 border border-slate-200 bg-white ${
                                isRecordingClone 
                     ...
                     <>
                        ...
                        {createStep === 'info' && (
                           <button
                             ...
                             className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                                !isSavingVoice && newVoiceName.trim() 
                                  ? 'bg-[#78d2e6] hover:bg-[#64c0d4] text-white shadow-xs active:scale-95' 
                                  : 'bg-slate-100 text-slate-400 cursor-not-allowed shadow-none'
                             }`}
                           >
                        ...
                        {createStep === 'design' && (
                           <button
                             ...
                             className={`px-5 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer ${
                                !isSavingVoice && newVoiceName.trim() && designPreviewVoiceId 
                                  ? 'bg-[#78d2e6] hover:bg-[#64c0d4] text-white shadow-xs active:scale-95' 
                                  : 'bg-slate-100 text-slate-400 cursor-not-allowed shadow-none'
                             }`}
                           >

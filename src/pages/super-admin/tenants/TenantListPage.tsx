...
export function TenantListPage({ onSelect }: { onSelect: (code: string) => void }) {
  ...
  return <section className="mx-auto w-full max-w-6xl space-y-6 text-slate-100">
    <header className="border-b border-white/10 pb-5"><h2 className="text-2xl font-bold">Quản lý doanh nghiệp</h2><p className="mt-1 text-sm text-slate-400">Tìm kiếm và theo dõi trạng thái tenant.</p></header>

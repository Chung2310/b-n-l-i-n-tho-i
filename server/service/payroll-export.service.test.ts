...
describe("payroll workbook exports", () => {
  it.each([
    ["detailed", "Payroll", ["Employee ID", "Employee Name", "Gross Pay"]],
    ["insurance", "Insurance", ["Employee ID", "Social Insurance", "Health Insurance"]],
    ["pit", "PIT", ["Employee ID", "Taxable Income", "Personal Income Tax"]],
    ["bank_transfer", "Bank Transfer", ["Employee ID", "Bank Account", "Amount"]],

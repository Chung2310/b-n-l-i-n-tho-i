...
export type PayrollAuditAction = "snapshot" | "lock" | "calculate" | "approve" | "close" | "adjustment" | "reset" | "create_run" | "sync_attendance" | "lock_attendance" | "review" | "reject" | "payment";

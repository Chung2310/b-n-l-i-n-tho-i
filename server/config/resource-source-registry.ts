...
const definitions = [
  ...
  defineSource({ sourceType: "hr.kanban", moduleKey: "hr", moduleLabel: "Nhân sự", groupKey: "kanban", groupLabel: "Công việc", requiredPermissions: ["kanban:read"], sourceTab: "NHÂN SỰ", sourceSubTab: "kanban" }),
  ...
  defineSource({ sourceType: "hr.celebration", moduleKey: "hr", moduleLabel: "Nhân sự", groupKey: "celebration", groupLabel: "Email chúc mừng", requiredPermissions: ["company-email:manage"], sourceTab: "NHÂN SỰ", sourceSubTab: "email-chuc-mung" }),
  ...
  defineSource({ sourceType: "student.profile", moduleKey: "student", moduleLabel: "Quản lý học viên", groupKey: "profiles", groupLabel: "Hồ sơ học viên", requiredPermissions: ["student:read"], sourceTab: "QUẢN LÝ HỌC VIÊN", sourceSubTab: "hoc-vien" }),
  defineSource({ sourceType: "student.custom-field", moduleKey: "student", moduleLabel: "Quản lý học viên", groupKey: "custom-fields", groupLabel: "Tài liệu tùy chỉnh", requiredPermissions: ["student:read"], sourceTab: "QUẢN LÝ HỌC VIÊN", sourceSubTab: "hoc-vien" }),
  defineSource({ sourceType: "student.assignment", moduleKey: "student", moduleLabel: "Quản lý học viên", groupKey: "assignments", groupLabel: "Bài tập", requiredPermissions: ["student:read"], sourceTab: "QUẢN LÝ HỌC VIÊN", sourceSubTab: "lop-hoc" }),
  defineSource({ sourceType: "student.submission", moduleKey: "student", moduleLabel: "Quản lý học viên", groupKey: "submissions", groupLabel: "Bài nộp", requiredPermissions: ["student:read"], sourceTab: "QUẢN LÝ HỌC VIÊN", sourceSubTab: "lop-hoc" }),
  defineSource({ sourceType: "student.face", moduleKey: "student", moduleLabel: "Quản lý học viên", groupKey: "face", groupLabel: "Khuôn mặt học viên", requiredPermissions: ["student:read"], sourceTab: "QUẢN LÝ HỌC VIÊN", sourceSubTab: "hoc-vien" }),
  ...
  defineSource({ sourceType: "inventory.product", moduleKey: "inventory", moduleLabel: "Kho & Sản phẩm", groupKey: "product-images", groupLabel: "Hình ảnh sản phẩm", requiredPermissions: ["stock:read"], sourceTab: "KHO & SẢN PHẨM", sourceSubTab: "danh-muc" }),
  defineSource({ sourceType: "import.worker", moduleKey: "imports", moduleLabel: "Dữ liệu nhập", groupKey: "workers", groupLabel: "Nhân viên", requiredPermissions: ["worker:read"], sourceTab: "QUẢN LÝ LAO ĐỘNG" }),
  defineSource({ sourceType: "import.student", moduleKey: "imports", moduleLabel: "Dữ liệu nhập", groupKey: "students", groupLabel: "Học viên", requiredPermissions: ["student:read"], sourceTab: "QUẢN LÝ HỌC VIÊN" }),
  defineSource({ sourceType: "import.partner", moduleKey: "imports", moduleLabel: "Dữ liệu nhập", groupKey: "partners", groupLabel: "Đối tác", requiredPermissions: ["partner:read"], sourceTab: "ĐỐI TÁC" }),
  defineSource({ sourceType: "import.exam", moduleKey: "imports", moduleLabel: "Dữ liệu nhập", groupKey: "exams", groupLabel: "Kỳ thi", requiredPermissions: ["student:read"], sourceTab: "QUẢN LÝ HỌC VIÊN", sourceSubTab: "lich-thi" }),
  defineSource({ sourceType: "import.inventory-product", moduleKey: "imports", moduleLabel: "Dữ liệu nhập", groupKey: "inventory-products", groupLabel: "Sản phẩm kho", requiredPermissions: ["stock:read"], sourceTab: "KHO & SẢN PHẨM", sourceSubTab: "danh-muc" }),
  defineSource({ sourceType: "import.inventory-stock", moduleKey: "imports", moduleLabel: "Dữ liệu nhập", groupKey: "inventory-stock", groupLabel: "Phiếu nhập xuất", requiredPermissions: ["stock:read"], sourceTab: "KHO & SẢN PHẨM" }),
  ...
  defineSource({ sourceType: "settings.profile", moduleKey: "settings", moduleLabel: "Cài đặt", groupKey: "profiles", groupLabel: "Hồ sơ cá nhân", requiredPermissions: ["user:read"], sourceTab: "CÀI ĐẶT", sourceSubTab: "ho-so" }),
  defineSource({ sourceType: "public.registration", moduleKey: "student", moduleLabel: "Quản lý học viên", groupKey: "registrations", groupLabel: "Hồ sơ đăng ký", requiredPermissions: ["student:read"], sourceTab: "QUẢN LÝ HỌC VIÊN", sourceSubTab: "hoc-vien" }),
  defineSource({ sourceType: "company.branding", moduleKey: "settings", moduleLabel: "Cài đặt", groupKey: "branding", groupLabel: "Nhận diện doanh nghiệp", requiredPermissions: ["user:manage"], sourceTab: "CÀI ĐẶT", sourceSubTab: "cau-hinh" }),

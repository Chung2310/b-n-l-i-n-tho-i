...
const studentFaceEnrollmentAuditSchema =
  new Schema<IStudentFaceEnrollmentAudit>(
    {
...
studentFaceEnrollmentAuditSchema.index({
  ownerId: 1,
  studentId: 1,
  attemptedAt: -1,
});

export const StudentFaceEnrollmentAuditModel =
  model<IStudentFaceEnrollmentAudit>(
    "WorkerStudentFaceEnrollmentAudit",
    studentFaceEnrollmentAuditSchema,
    "studentfaceenrollmentaudits",
  );

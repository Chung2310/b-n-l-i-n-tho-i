...
const requireManage = requireAnyPermission([
  ...STUDENT_AREA_PERMISSIONS["student-resource"].manage,
]) as any;
...
router.post(
  "/categories",
  requireManage,
  validate(createResourceCategorySchema),
  ResourceCategoryController.create,
);
router.delete(
  "/categories/:id",
  requireManage,
  validate(idParamSchema, "params"),
  ResourceCategoryController.delete,
);
...
router.post(
  ...
  ResourceController.book,
);
router.delete(
  "/:id/bookings/:bookingId",
  requireManage,
  ResourceController.cancelBooking,
);

...
import {
  ...
  publicRegisterStudentSchema,
  assignStudentBranchSchema,
...
publicStudentRouter.post(
  "/public-register",
  publicApiRateLimiter,
  validate(publicRegisterStudentSchema),
  StudentController.publicRegister,
);
publicStudentRouter.get(
  "/public-lookup",
  publicApiRateLimiter,
  StudentController.publicLookup,
);
...
router.get(
  ...
  adminUnassignedAuthMiddleware,
  requireManage,
  StudentController.getUnassignedList,
);
router.patch(
  "/:id/assign-branch",
  adminUnassignedAuthMiddleware,
  ...
  validate(assignStudentBranchSchema),
  StudentController.assignBranch,
);
...
router.patch(
  "/:id/installment/:no/mark-paid",
  requireManage,
  validate(installmentParamsSchema, "params"),
  StudentController.markInstallmentPaid,
);

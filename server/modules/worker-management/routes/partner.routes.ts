...
router.post(
  "/commission-levels",
  requireManage,
  validate(createCommissionLevelSchema),
  PartnerController.createCommissionLevel,
);
router.delete(
  "/commission-levels/:id",
  requireManage,
  validate(idParamSchema, "params"),
  PartnerController.deleteCommissionLevel,
);

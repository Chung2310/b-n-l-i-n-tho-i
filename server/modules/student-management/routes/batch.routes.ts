...
router.patch("/:id/learners/:studentId/enrollment-status", requireManage, validate(idParamSchema, "params"), validate(updateEnrollmentStatusSchema), BatchController.updateEnrollmentStatus);

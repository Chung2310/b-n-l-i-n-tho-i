...
export const moduleSettingsSchema = new Schema<IModuleSettings>(
  {
    ...
    entityPreset: { type: String, required: true, enum: ENTITY_PRESETS, default: "student" },
    updatedBy: { type: String, required: true },
  },
  { timestamps: true },
);

export const ModuleSettings = model<IModuleSettings>("StudentModuleSettings", moduleSettingsSchema);

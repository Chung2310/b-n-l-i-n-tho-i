...
export class NotificationController {
  static async create(req: AuthRequest, res: Response) {
    try {
      ...
      const notification = await NotificationService.createNotification(ownerId, req.user!.branchId!, req.body);
  ...
  static async getList(req: AuthRequest, res: Response, next: NextFunction) {
    try {
      ...
      const result = await NotificationService.getNotifications(ownerId, req.query, req.user!.branchId!);
  ...
  static async delete(req: AuthRequest, res: Response) {
    try {
      const ownerId = await getAllowedOwnerIds(req.user!);
      const notification = await NotificationService.deleteNotification(ownerId, req.params.id, req.user!.branchId!);
      if (!notification) {

...
const HistorySchema = new Schema({ from: String, to: String, at: { type: Date, required: true }, by: { type: String, required: true }, byName: { type: String, required: true }, note: String, customerNotified: { type: Boolean, default: false } }, { _id: false });

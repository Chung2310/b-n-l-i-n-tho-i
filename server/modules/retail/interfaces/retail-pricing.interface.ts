...
export interface PricingItemInput { productId: string; sku: string; productName: string; unit: string; category?: string; brand?: string; quantity: number; unitPrice: number; unitCost: number; discount?: DiscountInput; note?: string }

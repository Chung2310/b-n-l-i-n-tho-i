...
export interface PricingItemInput { productId: string; sku: string; productName: string; unit: string; category?: string; brand?: string; quantity: number; unitPrice: number; unitCost: number; trackingMode?: "none" | "quantity" | "unit_barcode" | "lot" | "serial"; variantId?: string; serialNumbers?: string[]; internalBarcodes?: string[]; discount?: DiscountInput; note?: string }

...
export interface RetailOrderItem { productId: string; sku: string; productName: string; unit: string; category?: string; quantity: number; unitPrice: number; unitCost: number; discountAmount: number; lineTotal: number; note?: string }

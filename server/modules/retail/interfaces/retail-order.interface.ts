...
export interface RetailOrderItem { productId: string; sku: string; productName: string; unit: string; category?: string; brand?: string; quantity: number; unitPrice: number; unitCost: number; discountAmount: number; lineTotal: number; trackingMode?: "none" | "quantity" | "lot" | "serial"; serialNumbers?: string[]; note?: string }

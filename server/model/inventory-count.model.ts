...
const InventoryCountItemSchema = new Schema<IInventoryCountItem>(
  {
    ...
    expectedUnits: { type: [{ _id: false, serialUnitId: String, internalBarcode: String, serialNumber: String }], default: undefined },
    scannedUnitIds: { type: [String], default: undefined },

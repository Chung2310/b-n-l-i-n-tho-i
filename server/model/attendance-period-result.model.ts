...
const schema = new Schema<IAttendancePeriodResult>({
  ...
  monthlySalary: { type: Number, required: true, min: 0 }, standardHours: { type: Number, required: true, min: 1 }, standardDays: { type: Number, required: true, min: 1 }, shortageMinutes: { type: Number, required: true, min: 0, default: 0 }, workedDays: { type: Number, min: 0 }, shortageDays: { type: Number, min: 0 },
